...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/refund/TCR3 - Credit Transfer Validity/TCR3.in.txt" > "../../scripts/refund/outputTCR3.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/refund/outputTCR3.txt" "../../test_cases/refund/TCR3 - Credit Transfer Validity/TCR3.out.txt"
        if [ $? -eq 0 ]; then
