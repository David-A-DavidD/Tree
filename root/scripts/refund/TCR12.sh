...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/refund/TCR12 - Username Validity (Seller) (success)/TCR12.in.txt" > "../../scripts/refund/outputTCR12.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/refund/outputTCR12.txt" "../../test_cases/refund/TCR12 - Username Validity (Seller) (success)/TCR12.out.txt"
        if [ $? -eq 0 ]; then
