...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/refund/TCR2 - Username Validity (Seller) (fail)/TCR2.in.txt" > "../../scripts/refund/outputTCR2.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/refund/outputTCR2.txt" "../../test_cases/refund/TCR2 - Username Validity (Seller) (fail)/TCR2.out.txt"
        if [ $? -eq 0 ]; then
