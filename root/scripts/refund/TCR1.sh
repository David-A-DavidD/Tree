...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/refund/TCR1 - Username Validity (Buyer) (fail)/TCR1.in.txt" > "../../scripts/refund/outputTCR1.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/refund/outputTCR1.txt" "../../test_cases/refund/TCR1 - Username Validity (Buyer) (fail)/TCR1.out.txt"
        if [ $? -eq 0 ]; then
