...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/refund/TCR6 - Seller Admin Privileges Check/TCR6.in.txt" > "../../scripts/refund/outputTCR6.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/refund/outputTCR6.txt" "../../test_cases/refund/TCR6 - Seller Admin Privileges Check/TCR6.out.txt"
        if [ $? -eq 0 ]; then
