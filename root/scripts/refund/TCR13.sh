...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/refund/TCR13 - Buyer Game Availability (success)/TCR13.in.txt" > "../../scripts/refund/outputTCR13.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/refund/outputTCR13.txt" "../../test_cases/refund/TCR13 - Buyer Game Availability (success)/TCR13.out.txt"
        if [ $? -eq 0 ]; then
