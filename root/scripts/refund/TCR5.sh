...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/refund/TCR5 - Buyer Refund Balance Increase/TCR5.in.txt" > "../../scripts/refund/outputTCR5.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/refund/outputTCR5.txt" "../../test_cases/refund/TCR5 - Buyer Refund Balance Increase/TCR5.out.txt"
        if [ $? -eq 0 ]; then
