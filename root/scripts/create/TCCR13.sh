...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/create/TCCR13 - valid username creation/TCCR13.in.txt" > "../../scripts/create/outputTCCR12.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/create/outputTCCR13.txt" "../../test_cases/create/TCCR13 - valid username creation/TCCR13.out.txt"
        if [ $? -eq 0 ]; then
