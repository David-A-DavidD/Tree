...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/create/TCCR12 - Valid creation, Daily Transaction file/TCCR12.in.txt" > "../../scripts/create/outputTCCR12.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/create/outputTCCR12.txt" "../../test_cases/create/TCCR12 - Valid creation, Daily Transaction file/TCCR12.out.txt"
        if [ $? -eq 0 ]; then
