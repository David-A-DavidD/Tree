...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/create/TCCR16 - create user without specifying user type/TCCR16.in.txt" > "../../scripts/create/outputTCCR16.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/create/outputTCCR16.txt" "../../test_cases/create/TCCR16 - create user without specifying user type/TCCR16.out.txt"
        if [ $? -eq 0 ]; then
