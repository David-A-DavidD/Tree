...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/create/TCCR8 - admin user type selection/TCCR8.in.txt" > "../../scripts/create/outputTCCR8.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/create/outputTCCR8.txt" "../../test_cases/create/TCCR8 - admin user type selection/TCCR8.out.txt"
        if [ $? -eq 0 ]; then
