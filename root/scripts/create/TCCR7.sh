...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/create/TCCR7 - user type selection prompt/TCCR7.in.txt" > "../../scripts/create/outputTCCR7.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/create/outputTCCR7.txt" "../../test_cases/create/TCCR7 - user type selection prompt/TCCR7.out.txt"
        if [ $? -eq 0 ]; then
