...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/create/TCCR19 - Transaction Code Validity/TCCR19.in.txt" > "../../scripts/create/outputTCCR19.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/create/outputTCCR19.txt" "../../test_cases/create/TCCR19 - Transaction Code Validity/TCCR19.out.txt"
        if [ $? -eq 0 ]; then
