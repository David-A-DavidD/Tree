...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/create/TCCR4 - username existence check/TCCR4.in.txt" > "../../scripts/create/outputTCCR4.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/create/outputTCCR1.txt" "../../test_cases/create/TCCR4 - username existence check/TCCR4.out.txt"
        if [ $? -eq 0 ]; then
