...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/create/TCCR18 - username creation of exactly 15 characters/TCCR18.in.txt" > "../../scripts/create/outputTCCR18.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/create/outputTCCR18.txt" "../../test_cases/create/TCCR18 - username creation of exactly 15 characters/TCCR18.out.txt"
        if [ $? -eq 0 ]; then
