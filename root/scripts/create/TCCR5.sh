...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/create/TCCR5 - user max credit limit/TCCR5.in.txt" > "../../scripts/create/outputTCCR5.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/create/outputTCCR1.txt" "../../test_cases/create/TCCR5 - user max credit limit/TCCR5.out.txt"
        if [ $? -eq 0 ]; then
