...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/create/TCCR14 - empty username submission/TCCR14.in.txt" > "../../scripts/create/outputTCCR14.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/create/outputTCCR14.txt" "../../test_cases/create/TCCR14 - empty username submission/TCCR14.out.txt"
        if [ $? -eq 0 ]; then
