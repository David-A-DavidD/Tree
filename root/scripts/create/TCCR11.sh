...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/create/TCCR11 - sell-standard user type selection/TCCR11.in.txt" > "../../scripts/create/outputTCCR11.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/create/outputTCCR11.txt" "../../test_cases/create/TCCR11 - sell-standard user type selection/TCCR11.out.txt"
        if [ $? -eq 0 ]; then
