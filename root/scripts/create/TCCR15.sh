...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/create/TCCR15 - create user with a credit exceeding 999,999/TCCR15.in.txt" > "../../scripts/create/outputTCCR15.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/create/outputTCCR15.txt" "../../test_cases/create/TCCR15 - create user with a credit exceeding 999,999/TCCR15.out.txt"
        if [ $? -eq 0 ]; then
