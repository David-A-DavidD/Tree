...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/delete/TCD2 - valid admin username/TCCR2.in.txt" > "../../scripts/create/outputTCCR19.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/delete/outputTCCR2.txt" "../../test_cases/delete/TCD2 - valid admin username/TCCR2.out.txt"
        if [ $? -eq 0 ]; then
