...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/delete/TCD5 - check admin loginy/TCD5.in.txt" > "../../scripts/create/outputTCD5.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/delete/outputTCD5.txt" "../../test_cases/delete/TCD5 - check admin login/TCD5.out.txt"
        if [ $? -eq 0 ]; then
