...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/delete/TCD4 - daily transaction file information/TCD4.in.txt" > "../../scripts/create/outputTCD4.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/delete/outputTCCR19.txt" "../../test_cases/delete/TCD4 - daily transaction file information/TCD4.out.txt"
        if [ $? -eq 0 ]; then
