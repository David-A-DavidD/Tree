...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/delete/TCD6 - check non-admin login/TCD6.in.txt" > "../../scripts/create/outputTCD6.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/delete/outputTCD6.txt" "../../test_cases/delete/TCD6 - check non-admin login/TCD6.out.txt"
        if [ $? -eq 0 ]; then
