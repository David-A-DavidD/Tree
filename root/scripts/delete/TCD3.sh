...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/delete/TCD3 - invalid admin username/TCD3.in.txt" > "../../scripts/create/outputTCD3.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/delete/outputTCD3.txt" "../../test_cases/delete/TCD3 - invalid admin username/TCD3.out.txt"
        if [ $? -eq 0 ]; then
