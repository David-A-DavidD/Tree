...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/delete/TCD7 - username existence check/TCD7.in.txt" > "../../scripts/create/outputTCD7.txt"

    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/delete/outputTCD7.txt" "../../test_cases/delete/TCD7 - username existence check/TCD7.out.txt"
        if [ $? -eq 0 ]; then
