...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/login/TCLI3-Valid Game Inventory Test/TC3.in.txt" > "../../scripts/logout/outputTCLI3.txt"
    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/login/outputTCLI3.txt" "../../test_cases/login/TCLI3-Valid Game Inventory Test/TC3.out.txt"
        if [ $? -eq 0 ]; then
