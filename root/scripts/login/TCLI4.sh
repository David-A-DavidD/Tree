...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/login/TCLI4-Invalid Game Inventory Test/TCLI4.in.txt" > "../../scripts/logout/outputTCLI4.txt"
    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/login/outputTCLI4.txt" "../../test_cases/login/TCLI4-Invalid Game Inventory Test/TCLI4.out.txt"
        if [ $? -eq 0 ]; then
