...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/login/TCLI1 - Checking if User is Logged In (fail)/TCLI1.in.txt" > "../../scripts/logout/outputTCLI1.txt"
    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/login/outputTCLI1.txt" "../../test_cases/login/TCLI1-Valid Username Test/TCLI1.out.txt"
        if [ $? -eq 0 ]; then
