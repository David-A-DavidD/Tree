...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/login/TCLI5- Valid Account Login Transaction Test/TC5.in.txt" > "../../scripts/logout/outputTCLI5.txt"
    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/login/outputTCLI5.txt" "../../test_cases/login/TCLI5- Valid Account Login Transaction Test/TC5.out.txt"
        if [ $? -eq 0 ]; then
