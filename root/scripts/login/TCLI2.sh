...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/login/TCLI2-Invalid Username Test/TCLI2.in.txt" > "../../scripts/logout/outputTCLI2.txt"
    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/login/outputTCLI2.txt" "../../test_cases/login/TCLI2-Invalid Username Test/TCLI2.out.txt"
        if [ $? -eq 0 ]; then
