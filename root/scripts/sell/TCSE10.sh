...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/sell/TCSE10-Invalid Unique Name Test/TCSE10.in.txt" > "../../scripts/logout/outputTCSE10.txt"
    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/login/outputTCSE10.txt" "../../test_cases/sell/TCSE9-Valid Unique Name Test/TCSE10.out.txt"
        if [ $? -eq 0 ]; then
