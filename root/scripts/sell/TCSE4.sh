...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../..root/test_cases/sell/TCSE4-Invalid Threshold Game Price Test/TCSE4.in.txt" > "../../scripts/logout/outputTCSE4.txt"
    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/login/outputTCSE4.txt" "../../test_cases/sell/TCSE4-Invalid Threshold Game Price Test/TCSE4.out.txt"
        if [ $? -eq 0 ]; then
