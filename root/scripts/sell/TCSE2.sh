...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/sell/TCSE2-Invalid Game Price Test/TCSE2.in.txt" > "../../scripts/logout/outputTCSE2.txt"
    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/login/outputTCSE2.txt" "../../test_cases/sell/TCSE2-Invalid Game Price Test/TCSE2.out.txt"
        if [ $? -eq 0 ]; then
