...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/sell/TCSE9-Valid Unique Name Test/TCSE9.in.txt" > "../../scripts/logout/outputTCSE9.txt"
    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/login/outputTCSE9.txt" "../../test_cases/sell/TCSE9-Valid Unique Name Test/TCSE9.out.txt"
        if [ $? -eq 0 ]; then
