...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../..root/test_cases/sell/TCSE7-Valid Session End Test/TC7.in.txt" > "../../scripts/logout/outputTCSE7.txt"
    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/login/outputTCSE7.txt" "../../test_cases/sell/TCSE7-Valid Session End Test/TC7.out.txt"
        if [ $? -eq 0 ]; then
