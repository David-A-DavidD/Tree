...
if [ $? -eq 0 ]; then
    ...
    ../../project/main < "../../test_cases/sell/TCSE8-Invalid Session End Test/TCSE8.in.txt" > "../../scripts/logout/outputTCSE8.txt"
    # Check if program execution was successful
    if [ $? -eq 0 ]; then
        echo "Program executed successfully."
        # Compare output with expected output
        diff -q "../../scripts/login/outputTCSE8.txt" "../../test_cases/sell/TCSE8-Invalid Session End Test/TCSE8.out.txt"
        if [ $? -eq 0 ]; then
